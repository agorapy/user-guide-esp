...
La casilla de verificación **a menos que haya sido sobreescrito arriba** significa que si tiene un producto con la misma propiedad, tanto heredado como aplicado, la nueva propiedad aplicada sobreescribirá la propiedad heredada del producto. Por ejemplo, un productor/a almacena principalmente huevos de gallina, pero también vende "leche de vaca" en menor frecuencia. Se aplicó la propiedad **rango libre** con la **descripción** "población de 50 pollos por hectárea" al negocio mismo, entonces la "leche de vaca" también es **rango libre** pero su descripción debe ser "1 individuo por hectárea", la propiedad heredada pero se sobre escribe una nueva **descripción** correcta.
