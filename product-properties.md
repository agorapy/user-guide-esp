...
El componente 'a menos que se invalide arriba' de la casilla de verificación significa que si tiene un producto con la misma propiedad, tanto heredado como aplicado, el campo 'valor' de la propiedad aplicada anulará el heredado. Por ejemplo, un productor almacena principalmente productos de carne de res, además de algunos cartones de huevos. Han aplicado la propiedad de rango libre a su empresa, con un valor \ (descripción \) de 'densidad de almacenamiento de 4 cabezas de ganado por acre'. Su producto 'cartón de huevo' también es de 'rango libre', sin embargo, el valor debe ser 'nuestras gallinas viven en una camioneta de huevos móvil, con una densidad de 50 pollos por acre'. La caja de cartón de la propiedad del huevo puede tener marcada la casilla de verificación 'Heredar propiedades ...', pero también necesitará una propiedad de 'rango libre' creada, con el campo de valor correcto.
